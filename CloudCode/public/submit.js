...
function submitQuestion() {
	...
	if (validation()) {
		...
		var correctPhoto = document.getElementById("correctPhoto").files[0];
		var correctPhotoName = document.getElementById("correctPhoto").name; 
		var wrongPhoto1 = document.getElementById("wrongPhoto1").files[0];
		var wrongPhoto1Name = document.getElementById("wrongPhoto1").name;
		var wrongPhoto2 = document.getElementById("wrongPhoto2").files[0];
		var wrongPhoto2Name = document.getElementById("wrongPhoto2").name;
		var wrongPhoto3 = document.getElementById("wrongPhoto3").files[0];
		var wrongPhoto3Name = document.getElementById("wrongPhoto3").name;

		var parseCorrectPhoto = new Parse.File("image1", correctPhoto);
		var parseWrongPhoto1 = new Parse.File("image2", wrongPhoto1);
		var parseWrongPhoto2 = new Parse.File("image3", wrongPhoto2);
		var parseWrongPhoto3 = new Parse.File("image4", wrongPhoto3);

		parseCorrectPhoto.save().then(function() {
			parseWrongPhoto1.save().then(function() {
				parseWrongPhoto2.save().then(function() {
					parseWrongPhoto3.save().then(function() {
						var QuestionObject = Parse.Object.extend("Question");
						var questionObject = new QuestionObject();
						questionObject.set("text", questionText);
						questionObject.set("wrongImage", parseCorrectPhoto);
						questionObject.set("correctImage1", parseWrongPhoto1);
						questionObject.set("correctImage2", parseWrongPhoto2);
						questionObject.set("correctImage3", parseWrongPhoto3);

						questionObject.save(null, {
							success: function(object) {
								alert('New object created with objectId: ' + object.id);
								document.getElementById("questionText").value = "";
								document.getElementById("correctPhoto").value = "";
								document.getElementById("correctImage").src = "";
								document.getElementById("wrongPhoto1").value = "";
								document.getElementById("wrongImage1").src = "";
								document.getElementById("wrongPhoto2").value = "";
								document.getElementById("wrongImage2").src = "";
								document.getElementById("wrongPhoto3").value = "";
								document.getElementById("wrongImage3").src = "";
							},
						...
						alert("Couldn't save4");
					});
				}, function(error) {
					alert("Couldn't save3");
				});
			}, function(error) {
				alert("Couldn't save2");
			});

		}, function(error) {
			alert("Couldn't save1");
		});
	}
}

function previewFile() {
	var preview = document.getElementById("correctImage");
	var file = document.getElementById("correctPhoto").files[0];
...
function previewFile1() {
	var preview = document.querySelector("#wrongImage1"); //selects the query named img
	var file = document.getElementById("wrongPhoto1").files[0];
	var reader = new FileReader();
...
function previewFile2() {
	var preview = document.querySelector("#wrongImage2"); //selects the query named img
	var file = document.getElementById("wrongPhoto2").files[0];
	var reader = new FileReader();
...
function previewFile3() {
	var preview = document.querySelector("#wrongImage3"); //selects the query named img
	var file = document.getElementById("wrongPhoto3").files[0];
	var reader = new FileReader();
...
function validation() {
	var questionText = document.getElementById("questionText").value;
	var correctPhoto = document.getElementById("correctPhoto").value;
	var wrongPhoto1 = document.getElementById("wrongPhoto1").value;
	var wrongPhoto2 = document.getElementById("wrongPhoto2").value;
	var wrongPhoto3 = document.getElementById("wrongPhoto3").value;

	if (questionText === '' || correctPhoto === '' || wrongPhoto1 === '' || wrongPhoto2 === '' || wrongPhoto3 === '') {
		alert("Fill all dem fields son");
		return false;
	} else {
		return true;
	}
